...
public class ColourizedRoute {
    ...
    public List<LatLng> processCheckpoints(final List<ColourizedRouteSegment> colourizedRouteSegments) {
        ...
        if (!checkpoints.isEmpty()) {
            ColourizedRouteSegment lastColourizedSegment
                    = colourizedRouteSegments.get(colourizedRouteSegments.size() - 1);

            int routeSegmentCount = lastColourizedSegment.getRouteSegments().size();
            LatLng lastCheckpoint = lastColourizedSegment
                    .getRouteSegments()
